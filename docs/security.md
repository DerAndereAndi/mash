...
- **Purpose:** Proves device identity and manufacturer
- **Issuer:** Manufacturer CA (optional) or self-signed
- **Validity:** 20 years (device lifetime)
- **Pre-installed:** At manufacturing time
- **Optional:** Devices without manufacturer CA use self-signed

### 2.2 Operational Certificate
